...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.compaction.autoCompactionEnabled":
    "Enables normal threshold-based auto-compaction for regular turns. Set false when a surface should stay manual-only but still allow explicit /compact-style compaction flows.",
